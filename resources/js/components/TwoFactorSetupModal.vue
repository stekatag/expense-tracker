...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            title: '2FA е активирана',
            description:
                'Двуфакторната автентикация е включена. Сканирай QR кода или въведи ключа ръчно в приложението си.',
            buttonText: 'Затвори',
        };
    }
    ...
    return {
        title: 'Включи двуфакторна автентикация',
        description:
            'За да завършиш настройката, сканирай QR кода или въведи ключа ръчно в приложението си.',
        buttonText: 'Продължи',
    };
});
